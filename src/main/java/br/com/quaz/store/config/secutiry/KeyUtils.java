...
public class KeyUtils {
    ...
    private KeyPair getKeyPair(String publicKeyPath, String privateKeyPath) {
        ...
        final var publicKeyFile = new File(publicKeyPath);
        final var privateKeyFile = new File(privateKeyPath);
        ...
        if (publicKeyFile.exists() && privateKeyFile.exists()) {
            ...
            try {
                ...
                final var publicKeyBytes = Files.readAllBytes(publicKeyFile.toPath());
        ...
        final var directory = new File("access-refresh-token-keys");
        if (!directory.exists()) {
            directory.mkdirs();
        }
        try {
